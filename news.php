...
$news = $con->prepare("SELECT  * FROM  news");
      // Execute The Statement
      $news->execute();
      // Assign To Variable 
      $blog = $news->fetchAll();
            ...
            <div class="">
                ...
                <div class="collapse navbar-collapse navbar-right">
                      ...
                      <?php if($_SESSION['lang']=='en'){?>
                        ...
                        <li class="scroll active"><a href="news.php" data="#news"> المدونة</a></li>
        ...
        <div class="container" id="news">
             ...
             <div class="row">
              ...
              if($do=='List'){
                ...
                <h2 class="section-title text-center wow fadeInDown" style="font-size: 40px">المدونة<img src="images/point.png" width="100"></h2>
            </div>';
                foreach($blog as $blg) {
                echo '<div class="text-center col-sm-12" >
                    <div class="blog-post blog-large wow fadeInLeft row" data-wow-duration="300ms" data-wow-delay="0ms">
                        <article class="row">
                            <header class="entry-header col-md-4 col-sm-12" style="float:right">
                            ...
                            <div class="entry-content media-body col-md-8 col-sm-12">
                                ';
                ...
                echo'</a></h2> <p class="text-right">'.substr($blg['arblogDesc'],0, 250).'</p>
                            ...
                            <a class="btn btn-primary btn-blog services-btn-dtl  btn-sm " href="news.php?do=Single&blogID='.$blg['blogID'].'"  >'.$lang['show'].'</a> 
                        </article>
                    </div>
                </div>
                    ';
              ...
              $blogID = isset($_GET['blogID']) && is_numeric($_GET['blogID']) ? intval($_GET['blogID']) : 0;
                ...
                $stmt = $con->prepare("SELECT * FROM news WHERE blogID = ?");
                ...
                $count = $stmt->rowCount();
                    ...
                    if ($count > 0) {
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-4 col-sm-5 col-xs-12 side-serv" style="background: rgba(177, 177, 177, 0.6);box-shadow: 0px 0px 10px 4px #e0e0e0;padding: 30px;float: right;margin-top:15px ">
